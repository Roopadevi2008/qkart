...
public class SearchResult {
    ...
    public String getTitleofResult() throws InterruptedException {
        ...
        WebElement title = parentElement.findElement(By.tagName("p"));
    ...
    public Boolean verifySizeChartExists() {
        ...
        try {
             ...
             */
           // WebElement sizeChartElement = this.parentElement
                    //.findElement(By.xpath("//div[contains(@class,'MuiCardContent-root')]//button"));
                    WebElement sizeChartElement =
                            this.parentElement.findElement(By.tagName("button"));
    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders, List<List<String>> expectedTableBody,
        ...
        try {
             ...
             * in the same order
             */
            WebElement parentofSizechart=
                    driver.findElement(By.className("MuiDialog-paperScrollPaper"));
            WebElement tableElement = parentofSizechart.findElement(By.tagName("table"));
