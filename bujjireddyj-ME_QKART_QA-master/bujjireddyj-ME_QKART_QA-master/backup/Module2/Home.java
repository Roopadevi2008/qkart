...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        ...
        try {
            ...
            // box
           // WebElement noResultMsg = driver.findElement(By.tagName("h4"));
            
            searchBoxElement = driver.findElement(By.xpath("//div[contains(@class,'MuiOutlinedInput-root MuiInputBase-root MuiInputBase-colorPrimary MuiInputBase-formControl MuiInputBase-sizeSmall MuiInputBase-adornedEnd search')]/input"));
            searchBoxElement.clear();
            searchBoxElement.sendKeys(product);
            searchBoxElement.clear();
            //searchBoxElement.sendKeys(Keys.ENTER);
           // if (noResultMsg.getText().equalsIgnoreCase("No products found "))
