...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            ExpectedConditions.presenceOfElementLocated(By.xpath("//h4[normalize-space(text()='No products found')]"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElementByXPath("//h4[normalize-space(text()='No products found')]").isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//div[contains(@class,'MuiBox-root css-1gjj37g')]")).getText().split("\n")[0]);
            }
