...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            WebElement parentBox = driver.findElement(By.xpath("//p[text()='"+addressToSelect+"']//ancestor::div[contains(@class,'MuiBox-root css-0')]"));
    ...
    public Boolean placeOrder() {
        try {
            ...
            List<WebElement> elements = driver.findElementsByXPath("//button[text()='PLACE ORDER']"); 
